...
option = options.Headpose_normal_Option()
train_Data = Data_set_body(option.number_points, 'val', "headposes")
...
print('NN loaded.')
model_dict_file = 'runs/model_headposes_normal_07-30_15h53m.ckpt'
